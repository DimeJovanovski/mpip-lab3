  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `Movie` (`imdbID` TEXT NOT NULL, `title` TEXT NOT NULL, `year` TEXT NOT NULL, `image` TEXT NOT NULL, PRIMARY KEY(`imdbID`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '537ae7095c7fc52ed65991a0a2e8a387')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoMovie.equals(_existingMovie)) {
          return new RoomOpenHelper.ValidationResult(false, "Movie(com.example.moviesdbapi.domain.movie.model.Movie).\n"
                  + " Expected:\n" + _infoMovie + "\n"
                  + " Found:\n" + _existingMovie);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "537ae7095c7fc52ed65991a0a2e8a387", "dae68688fe8d10f88dba22a9c61fe3de");
